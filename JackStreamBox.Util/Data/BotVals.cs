...
namespace JackStreamBox.Util.Data
{
    public class BotVals
    {
        ...
        {
            return new string[] { VOTE_TIMER, PICK_TIMER, REQUIRED_VOTES, BOT_NAME,"m1","m2","m3","m4","m5","m6","screen", GAMES_HOSTED, VOTE_TIMEOUT, XP_TIME,XP_AMOUNT, XP_RANDOM, RAFFLEXP, XP_MIN_VC_SIZE };
        }
